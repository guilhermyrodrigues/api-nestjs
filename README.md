...
Para manter a API estável e evolutiva:
- escreva testes para novos fluxos de sucesso/erro;
- mantenha os serviços retornando exceções HTTP do domínio;
- evite retornar dados sensíveis (como `password`) nos endpoints.
